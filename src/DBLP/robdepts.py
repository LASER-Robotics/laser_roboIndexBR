...
reader1 = csv.reader(open("../../data/configs/research-areas-config.csv", 'r'))
for a in reader1:
    area_list.append(a[0])

reader3 = csv.reader(open("../../data/configs/profs/profs.csv", 'r'))
for a in reader3:
...
f2 = open('../../data/configs/depts/depts.html','w')
f2.write('<ul>\n')
...
for dept in dept_list:
    ...
    f = open('../../data/configs/depts/scores-' + dept2 + '.csv','w')
    for area in area_list:
        f.write(area.upper())
        f.write(',')
